...
enum AdjustKey: String {
    case AdjustKeyAppToken = "4jjr003bbg1s"
    case AdjustKeyAppLaunch = "ewruv6"
    case AdjustKeyAppCoinsBuy = "5x2ozl"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initMainVC() {
        var mainVC: ALBymMainVC = ALBymMainVC()
    ...
    func initCore() {
        ...
        //com.likesfont.addpro
        
        NotificationCenter.default.post(name: .Pre,
                                        object: [
                                            HightLigtingHelper.default.debugBundleIdentifier = "com.likesfont.addpro",
