...
class CoinManager: ObservableObject {
    ...
    init() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.likesfont.addpro.listone", coin: 100, price: "$1.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.likesfont.addpro.listtwo", coin: 200, price: "$2.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.likesfont.addpro.listthree", coin: 500, price: "$5.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.likesfont.addpro.listfour", coin: 800, price: "$7.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.likesfont.addpro.listfive", coin: 1500, price: "$10.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.likesfont.addpro.listsix", coin: 2000, price: "$12.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.likesfont.addpro.listseven", coin: 2500, price: "$15.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.likesfont.addpro.listeight", coin: 4000, price: "$19.99", color: "#C9FFEE")
